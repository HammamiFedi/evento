...
export default function EventCard({ event }: EventCardProps) {
  ...
  return (
    ...
    >
      <section className="relative flex flex-col w-full h-full bg-white/[3%] rounded-xl overflow-hidden hover-effect cursor-pointer">
        <Image
          src={event.imageUrl}
          alt={event.name}
          width={500}
        ...
        <div className="flex flex-col flex-1 justify-center items-center">
          <h2 className="text-2xl font-semi-bold">{event.name}</h2>
